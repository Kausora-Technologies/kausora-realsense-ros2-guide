...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('camera_name', default_value='l515'),
        ...
        Node(
            ...
            parameters=[{
                ...
                # Color stream (1920x1080 @ 30fps max for L515)
                'enable_color': True,
                'color_width': 1920,
                'color_height': 1080,
                'color_fps': 30.0,
                # Depth stream — LiDAR-based structured light
                'enable_depth': True,
                'depth_width': 1024,
                'depth_height': 768,
                'depth_fps': 30.0,
        ...
        Node(
            ...
            arguments=['-d', PathJoinSubstitution([
                FindPackageShare('kausora_realsense_ros2'), 'rviz', 'l515.rviz'
            ])],
            output='screen',
        ),
    ])
